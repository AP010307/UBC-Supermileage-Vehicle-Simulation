function [T] = runUrbanMC(maxV_mean, maxV_sd, brakeDist_mean, brakeDist_sd, initialOutput_mean, initialOutput_sd,numTrials,generatePlots)
% runUrbanMC performs the full run of the monte carlo simulation for Urban Concept vehicle
...
for lapNumber = 1:totalLaps
    [energy1,energy2,energy3,time,energy_end] = urbanLapMC(maxV,distToBrake,initialOutput,numTrials);
    ...
    for j = 1:numTrials
        ...
        brakeEnergy(j) = brakeEnergy(j) + energy_end(j);
    end
end
toc;
for j = 1:numTrials
